            ...
            <ModalBody>
                <form>
                    <FormGroup>
                        ...
                        <Input type="text" name="nome" id="nome" placeholder="Nome da pessoa" value={this.state.nome} onChange={this.handleNome} />
                    </FormGroup>
                    ...
                    <FormGroup>
                        ...
                        <Input type="text" name="logo" id="logo" placeholder="ID do cartão" value={this.state.logo} onChange={this.handleLogo} />
                    </FormGroup>
                    ...
                    <FormGroup>
                        ...
                        <Input type="number" name="ano" id="ano" placeholder="Permissões" value={this.state.ano} onChange={this.handleAno} />
                    </FormGroup>
