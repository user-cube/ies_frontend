...
class AnaliseCO2 extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://deti-engsoft-02.ua.pt:3000/humidity/average/week', { headers: {"Authorization" : `Bearer ${token}`} })
            .then(res => {
                const co2 = res.data;
                let lista_labels = [];
                let lista_values = [];
                ...
                this.setState({humidity_labels: lista_labels, humidity_values: lista_values});
            });
    }
                                ...
                                <div className="chart-area" style={{height: 500}}>
                                    <Line
                                        data={canvas => {
                                            ...
                                            return {
                                                labels: this.state.humidity_labels,
                                                datasets: [
                                                    {
                                                        label: "Humidade",
                                                        fill: true,
                                                        ...
                                                        pointRadius: 4,
                                                        data: this.state.humidity_values
                                                    }
                                                ]
                                            };
                                        }}
